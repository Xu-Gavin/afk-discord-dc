...
class AfkMonitoringApp:
    def __init__(self, root: tk.Tk):
        ...
        entry_instructions = tk.Label(root, text="Enter the AFK threshold in seconds:")
        ...
        self.button = tk.Button(root, text="Toggle Monitoring", command=self.on_button_click)
    ...
    def activate_monitoring(self) -> None:
        try:
            ...
            self.thread = threading.Thread(target=self.start_afk_monitoring, args=[self.stop_flag, afk_time_int])
    ...
    def start_afk_monitoring(self, stop_flag: threading.Event, afk_time: int):
